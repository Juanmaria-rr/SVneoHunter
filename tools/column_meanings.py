...
MEANINGS: dict[str, str] = {
    ...
    "alt_bp1": "The raw VCF ALT of breakend 1, e.g. `A[chr1:46279283[`. The "
    ...
    "strand1": "Strand of `transcript_id1`. Emitted because an unresolved strand "
    ...
    "gnomad_af_amr": "Frequency in Admixed American. A plausible reference for "
                     "the RPE1 line, whose donor ancestry is not documented.",
    ...
    "gnomad_af_nfe": "Frequency in Non-Finnish European. A plausible reference "
                     "for the RPE1 line, whose donor ancestry is not documented.",
...
def check(columns) -> list[str]:
    ...
    return [c for c in columns if c not in MEANINGS]
