...
indistinguishable from an RNA stage that ran and found nothing.
    ...
    python tools/build_html_report.py --run-dir results/RPE1-WT_PON10
...
def losses(caption: str, rows: list[dict], columns: list[str]) -> str:
    ...
    checked, argued with, or reconciled against a previous analysis; "removed
    ITGA11, PON_COUNT 3,513" can. This block exists because a reader who
...
<footer>
  ...
  (<code>docs/OPEN_QUESTIONS.md</code>) means no result here is strand-controlled.
</footer>
</div>"""
