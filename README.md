...
results_patch002/     the same analysis with the minus-strand fix applied, kept
                      separate so the correction can be measured rather than
                      silently applied. Each carries its own PROVENANCE.md
```
...
0 of 188 tested regions correct, against 87 of 87 on the plus strand. An intronic
