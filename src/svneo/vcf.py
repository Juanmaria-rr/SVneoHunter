...
def write_admitted_vcf(source_vcf: str, admitted: pd.DataFrame, out_path: str) -> int:
    ...
    # rejected record because its neighbour passed: one breakend with
    # PON_COUNT = 1,578 reached the generator that way and produced 8 peptides,
    # which is precisely what handing the generator the admitted set prevents.
