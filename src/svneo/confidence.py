...
They are not interchangeable, and the distinction decided a real case: an event
with perfect confidence metrics (VF 27, SEGMAPQ 60, QUAL 89, 1,536 TPM, 31
junction-crossing RNA reads, and a homozygous-deletion depth profile in DNA) was
nonetheless disqualified — PON_COUNT 3,513 means the junction is present in 3,513
unrelated normals. It is a real, well-called, well-expressed COMMON POLYMORPHISM.
