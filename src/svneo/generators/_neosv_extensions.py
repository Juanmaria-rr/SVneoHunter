    ...
    with open(path, "w") as handle:
        ...
        for fusion in fusions:
            ...
            base = {
                ...
                # Transcript strand, emitted because an unresolved strand skew is
                # an open question (docs/OPEN_QUESTIONS.md) and cannot be
                # investigated from a table that does not carry it.
