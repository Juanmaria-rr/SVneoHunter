...
>
> **Generated document — do not edit.** Built by `tools/build_focused_summary.py` from [`docs/EXECUTIVE_SUMMARY.md`](EXECUTIVE_SUMMARY.md). [`docs/EXECUTIVE_SUMMARY.md`](EXECUTIVE_SUMMARY.md) is the canonical version and additionally carries the panel-filtered comparison and the permutation null. Edit the source and rebuild.
>
